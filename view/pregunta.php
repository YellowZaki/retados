		...
		<div class="form-group col-md-12">
			<table class="table table-bordered table-hover" id="invoiceTable">				
				...
				<tbody style= ".table-hover">					
					...
					<tr>
						<td><input data-type="productCode" name="respuestas[]" id="itemNo_7" value="{{respuesta.TEXTO}}" class="form-control autocomplete_txt ui-autocomplete-input" autocomplete="off" type="text"></td>
